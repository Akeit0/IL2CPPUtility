...
namespace IL2CPPUtility {
    ...
    [DllImport(AssemblyName, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    public static extern Il2CppClassHandle il2cpp_class_from_name(Il2CppImageHandle image, [MarshalAs(UnmanagedType.LPUTF8Str)] string namespaze,
    ...
    [DllImport(AssemblyName, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    public static extern void* il2cpp_class_get_name(void* klass);

    [DllImport(AssemblyName, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    public static extern void* il2cpp_class_get_namespace(void* klass);

    [DllImport(AssemblyName, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    public static extern void* il2cpp_class_get_parent(void* klass);

    [DllImport(AssemblyName, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    public static extern void* il2cpp_class_get_declaring_type(void* klass);

    [DllImport(AssemblyName, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    public static extern int il2cpp_class_instance_size(void* klass);
    ...
    [DllImport(AssemblyName, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    [return: MarshalAs(UnmanagedType.I1)]
    public static extern bool il2cpp_class_is_valuetype(void* klass);
    ...
    [DllImport(AssemblyName, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    public static extern void il2cpp_field_get_value(Il2CppObjectHandle obj, Il2CppFieldInfoHandle field, void* value);

    [DllImport(AssemblyName, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    public static extern Il2CppObjectHandle il2cpp_field_get_value_object(Il2CppFieldInfoHandle field, Il2CppObjectHandle obj);
    ...
    [DllImport(AssemblyName, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    public static extern void il2cpp_field_set_value(Il2CppObjectHandle obj,Il2CppFieldInfoHandle field, void* value);
    ...
    [DllImport(AssemblyName, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
    public static extern void il2cpp_field_set_value_object(Il2CppObjectHandle instance, Il2CppFieldInfoHandle field, Il2CppObjectHandle value);
